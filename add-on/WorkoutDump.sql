...
--
-- Name: tracking; Type: TABLE; Schema: public; Owner: mraihanw_sbd
--
...
ALTER TABLE public.tracking OWNER TO mraihanw_sbd;

--
-- Name: tracking_TrackingID_seq; Type: SEQUENCE; Schema: public; Owner: mraihanw_sbd
--

CREATE SEQUENCE public."tracking_TrackingID_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."tracking_TrackingID_seq" OWNER TO mraihanw_sbd;

--
-- Name: tracking_TrackingID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mraihanw_sbd
--

ALTER SEQUENCE public."tracking_TrackingID_seq" OWNED BY public.tracking.trackingid;


--
-- Name: users; Type: TABLE; Schema: public; Owner: mraihanw_sbd
--
...
ALTER TABLE public.users OWNER TO mraihanw_sbd;

--
-- Name: users_userid_seq; Type: SEQUENCE; Schema: public; Owner: mraihanw_sbd
--
...
ALTER TABLE public.users_userid_seq OWNER TO mraihanw_sbd;

--
-- Name: users_userid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mraihanw_sbd
--
...
--
-- Name: workout; Type: TABLE; Schema: public; Owner: mraihanw_sbd
--
...
ALTER TABLE public.workout OWNER TO mraihanw_sbd;

--
-- Name: workout_ExerciseID_seq; Type: SEQUENCE; Schema: public; Owner: mraihanw_sbd
--

CREATE SEQUENCE public."workout_ExerciseID_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."workout_ExerciseID_seq" OWNER TO mraihanw_sbd;

--
-- Name: workout_ExerciseID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mraihanw_sbd
--

ALTER SEQUENCE public."workout_ExerciseID_seq" OWNED BY public.workout.workoutid;


--
-- Name: tracking trackingid; Type: DEFAULT; Schema: public; Owner: mraihanw_sbd
--

ALTER TABLE ONLY public.tracking ALTER COLUMN trackingid SET DEFAULT nextval('public."tracking_TrackingID_seq"'::regclass);


--
-- Name: users userid; Type: DEFAULT; Schema: public; Owner: mraihanw_sbd
--
...
--
-- Name: workout workoutid; Type: DEFAULT; Schema: public; Owner: mraihanw_sbd
--

ALTER TABLE ONLY public.workout ALTER COLUMN workoutid SET DEFAULT nextval('public."workout_ExerciseID_seq"'::regclass);


--
-- Data for Name: tracking; Type: TABLE DATA; Schema: public; Owner: mraihanw_sbd
--

COPY public.tracking (trackingid, date, weight, height, bmi, userid, progress) FROM stdin;
11	2022-06-19	85	180	381.1764705882353	1	50
12	2022-06-19	84	180	385.7142857142857	1	60
13	2022-06-19	80	180	405	1	35
14	2022-06-19	80	180	405	1	90
15	2022-06-19	84	180	385.7142857142857	1	20
\.


--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: mraihanw_sbd
--

COPY public.users (userid, username, password) FROM stdin;
1	raihan	$2a$10$K.62V8TW/3Di8.NO51jabe9FYJFSLCMJYXin2UJvpfAIfLM9Z2T.S
2	fateen	$2a$10$4HcbVXi456/u2KbNJ8DIeudp.o27DehOtgmI1lzwsVJoKpYzWzC5u
4	kemas	$2a$10$cg0S4Hl5PImHNW3EMWaO3OvjCsJjnk4y1zB6hfcDJ.D1tSMe8ygWi
9	embun	$2a$10$Vwo/Tdv/s0o9c8Si6zFyQ.w.0gYGIL6b.E2aY0ba/D11nCt.Xxq8e
\.


--
-- Data for Name: workout; Type: TABLE DATA; Schema: public; Owner: mraihanw_sbd
--

COPY public.workout (workoutid, name, bodypart, reps, sets, userid) FROM stdin;
8	Squat	Kaki	5	10	1
7	Plank	Perut	1	5	1
12	Push Up	Tangan	30	5	1
\.


--
-- Name: tracking_TrackingID_seq; Type: SEQUENCE SET; Schema: public; Owner: mraihanw_sbd
--

SELECT pg_catalog.setval('public."tracking_TrackingID_seq"', 15, true);


--
-- Name: users_userid_seq; Type: SEQUENCE SET; Schema: public; Owner: mraihanw_sbd
--
...
--
-- Name: workout_ExerciseID_seq; Type: SEQUENCE SET; Schema: public; Owner: mraihanw_sbd
--

SELECT pg_catalog.setval('public."workout_ExerciseID_seq"', 13, true);


--
-- Name: tracking tracking_pkey; Type: CONSTRAINT; Schema: public; Owner: mraihanw_sbd
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: mraihanw_sbd
--
...
--
-- Name: workout workout_pkey; Type: CONSTRAINT; Schema: public; Owner: mraihanw_sbd
--
